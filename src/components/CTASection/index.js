  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="fade-up opacity-0 translate-y-6 transition-all duration-700 delay-100 ease-out text-lg text-white mb-10 leading-relaxed">
        ...
        <div className="fade-up opacity-0 translate-y-6 transition-all duration-700 delay-300 ease-out mt-8 flex items-center justify-center gap-6 text-white text-sm flex-wrap">
